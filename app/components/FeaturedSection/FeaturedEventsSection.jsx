...
const FeaturedEventsSection = () => {
  ...
  const featuredEvents = [
    ...
    subtitle: 'शिक्षा के माध्यम से बदलाव',
    date: '24/06/2025',
    time: 'सुबह से शाम तक',
    location: 'मुंबई - विभिन्न गरीब बस्तियाँ',
    description: 'बरनवाल एकता संस्था, मुंबई द्वारा एक सामाजिक पहल के अंतर्गत झुग्गी बस्तियों में रहने वाले 140 बच्चों को शिक्षा सहायता प्रदान की गई। यह बच्चों को पढ़ाने वाली समर्पित महिलाओं के साथ मिलकर किया गया एक प्रेरणादायक प्रयास था।',
    highlights: [
      '3 स्थानों पर कार्यक्रम',
      '140 बच्चों को लाभ',
      'समर्पित महिला शिक्षकों से संवाद',
      'बच्चों द्वारा बनाए गए Thank You कार्ड्स',
      'शैक्षणिक सामग्री वितरण',
      'सामाजिक सहभागिता की प्रेरणा'
    ],
